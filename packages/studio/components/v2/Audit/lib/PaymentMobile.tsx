...
import { initialPaymentData } from "@/config/type/default/payment";
...
interface Props {
  data: { rows: Payment[]; total: number };
  selectedRow: Payment;
  setSelectedRow: React.Dispatch<React.SetStateAction<Payment>>;
...
const PaymentMobile = ({
  ...
  const handleChangePage = (
    ...
    setSelectedRow(initialPaymentData);
  };
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <Chip
                      sx={{ width: 50, mt: 1, height: 20, borderWidth: 2 }}
                      size="small"
                      variant="outlined"
                      label={check[item?.method]?.label}
                      color={check[item?.method]?.color}
                    />
                  </CardContent>
                </Box>
              </Grid>
