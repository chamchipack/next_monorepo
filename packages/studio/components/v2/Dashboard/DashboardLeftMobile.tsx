...
import EnrollmentChart from "./lib/EnrollmentChart";
    ...
    <Box sx={{ width: "100%" }}>
      <Box>
        <Tabs value={value} onChange={handleChange} centered>
          <Tab label="현황" value="status" />
          <Tab label="업무관리" value="work" />
        </Tabs>
      </Box>
      <Box sx={{ height: "100%" }}>
        {value === "status" ? (
          <Box sx={{ height: "100%", overflowX: "hidden" }}>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <Box
                      sx={{ display: "flex", alignItems: "end", pt: 4, ml: 2 }}
                    >
                      <Typography
                        variant="caption"
                        color="white"
              ...
              <Box sx={{ height: "100%" }}>
                <EnrollmentChart width="100%" />
              </Box>
              <Box sx={{ height: "100%" }}>
                <AttendanceChart width="100%" />
              </Box>
...
export default DashboardLeftMobile;
